...
import { getComments } from '@/graphql/comments'
import { getPostSlugs, getSinglePost } from '@/graphql/posts'
...
export default async function Post({ params }) {
	...
	let featuredImageUrl =
		'https://localhost/wp-content/uploads/2022/12/travel_icy-polar_022K.jpg'

	if (postData?.featuredImage) {
		featuredImageUrl =
			'url(' + postData.featuredImage.node.mediaDetails.sizes[0].sourceUrl + ')'
	}


	

	// let jsonSchema = seoData.schema.raw.replace(/https:\/\/localhost(?!\/wp-content\/uploads)/g, 'https://localhost/blog')
	...
	return (
		<>
			...
			<section className='container mx-auto lg:max-w-4xl pb-[120px]'>
				<ul>
